...
<script>
    function openTransaksiModal() {
        ...
        document.getElementById('submitBtn').innerHTML = '<i class="fas fa-plus"></i> Simpan Deals';
    ...
    function editTransaksi(id) {
        fetch(`/transaksi/${id}/edit`)
            ...
            .then(data => {
                ...
                document.getElementById('submitBtn').innerHTML = '<i class="fas fa-save"></i> Update Transaksi';
                document.getElementById('transaksiModal').classList.add('active');
            })
            .catch(error => {
