...
<div class="container-expanded mx-auto px-6 lg:px-8 py-8 pt-[60px] mt-4 fade-in">
    ...
    <!-- Pipeline Card dengan Everything Inside -->
        ...
        <div style="padding: 0.5rem 1.5rem; border-bottom: 1px solid #e5e7eb;">
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1">
                <div>
                    ...
                    <p style="font-size: 0.875rem; color: #6b7280; margin: 0.25rem 0 0 0;">Track your sales pipeline through different stages</p>
                </div>
...
<!-- Modals -->
<x-pipeline.action.action :currentMenuId="$currentMenuId" :stages="$stages" />
<x-pipeline.action.edit :currentMenuId="$currentMenuId" :stages="$stages" />

@push('scripts')
<script src="{{ asset('js/pipeline-modal.js') }}"></script>
@endpush
