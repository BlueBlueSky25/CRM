        <div class="mb-8 mt-12 fade-in">
            <div class="glass-effect rounded-2xl p-6 text-white relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <h2 class="text-3xl font-bold mb-2">Manajemen Industri</h2>
                    <p class="text-gray-200 text-lg">Kelola semua Industri dalam satu tempat dengan mudah dan efisien</p>
                </div>
