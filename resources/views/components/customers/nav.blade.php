...
<div id="sidebar" class="fixed left-0 top-0 h-full w-80 bg-white shadow-2xl z-40 sidebar closed overflow-y-auto">
    <div class="p-6">
        ...
        <nav class="space-y-2">
            <!-- Dashboard -->
            <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 text-gray-700 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg px-3 py-2 transition-all duration-200">
                <i class="fas fa-home w-5"></i>
                <span class="font-medium">Dashboard</span>
            </a>

            <!-- Customers -->
            <a href="{{ route('customers') }}" class="flex items-center space-x-3 text-indigo-600 bg-indigo-50 rounded-lg px-3 py-2 transition-all duration-200">
